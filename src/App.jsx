          ...
          <div className="page-1">
            ...
            <div className="section header-section">
              ...
              <p className="quote-text">
                „Ljubav je strpljiva, ljubav je dobrostiva; ne zavidi, ne hvasta
                se, ne nadima se. Sve pokriva, sve vjeruje, svemu se nada, sve
                podnosi. Ljubav nikada ne prestaje."
              </p>
